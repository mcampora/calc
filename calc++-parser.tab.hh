...
#line 125 "calc++-parser.tab.hh" // lalr1.cc:372
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_EQUAL (const location_type& l)
  {
    return symbol_type (token::TOK_EQUAL, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_NEQUAL (const location_type& l)
  {
    return symbol_type (token::TOK_NEQUAL, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_LT (const location_type& l)
  {
    return symbol_type (token::TOK_LT, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_GT (const location_type& l)
  {
    return symbol_type (token::TOK_GT, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_LTE (const location_type& l)
  {
    return symbol_type (token::TOK_LTE, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_GTE (const location_type& l)
  {
...
#line 1035 "calc++-parser.tab.hh" // lalr1.cc:372




#endif // !YY_YY_CALC_PARSER_TAB_HH_INCLUDED
